 ...
 * STIX Types
 * 
 * Core STIX object types used across the extension
 */
 ...
 */
export interface StixCyberObservable extends StixBaseObject {
 ...
 */
export interface StixDomainObject extends StixBaseObject {
  name: string;
  aliases?: string[];
  description?: string;
  x_mitre_id?: string;
 ...
 * Container types
 */
export type ContainerType = 'Report' | 'Grouping' | 'Note' | 'Case-Incident' | 'Case-Rfi' | 'Case-Rft';
